...
namespace QcmApp.Models
{
    public class OptionsController : Controller
    {
        ...
        public OptionsController(QcmContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Correct")] Option option)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Correct")] Option option)
        {
            if (id != option.Id)
            {
                return NotFound();
